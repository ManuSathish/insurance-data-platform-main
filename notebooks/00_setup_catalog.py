...
# MAGIC The catalog `insurance_catalog_manu` must be created via the Databricks UI BEFORE
...
# will automatically use insurance_catalog_manu.bronze, insurance_catalog_manu.silver, etc.
...
# MAGIC CREATE VOLUME IF NOT EXISTS insurance_catalog_manu.bronze.raw_data
# MAGIC COMMENT 'Raw landing-zone files for synthetic and public source data';

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE VOLUME IF NOT EXISTS insurance_catalog_manu.bronze.checkpoints
...
# MAGIC SHOW SCHEMAS IN insurance_catalog_manu;
