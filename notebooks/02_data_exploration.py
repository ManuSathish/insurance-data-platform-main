...
# MAGIC SELECT 'bronze_property_policies_csv' AS table_name, COUNT(*) AS row_count FROM insurance_catalog_manu.bronze.bronze_property_policies_csv
# MAGIC UNION ALL
# MAGIC SELECT 'bronze_property_claims_csv', COUNT(*) FROM insurance_catalog_manu.bronze.bronze_property_claims_csv
# MAGIC UNION ALL
# MAGIC SELECT 'bronze_workers_comp_policies_csv', COUNT(*) FROM insurance_catalog_manu.bronze.bronze_workers_comp_policies_csv
# MAGIC UNION ALL
# MAGIC SELECT 'bronze_auto_policies_csv', COUNT(*) FROM insurance_catalog_manu.bronze.bronze_auto_policies_csv
# MAGIC UNION ALL
# MAGIC SELECT 'bronze_general_liability_policies_csv', COUNT(*) FROM insurance_catalog_manu.bronze.bronze_general_liability_policies_csv
# MAGIC UNION ALL
# MAGIC SELECT 'bronze_umbrella_policies_csv', COUNT(*) FROM insurance_catalog_manu.bronze.bronze_umbrella_policies_csv
...
# MAGIC FROM insurance_catalog_manu.silver.silver_property_policies
# MAGIC UNION ALL
...
# MAGIC FROM insurance_catalog_manu.silver.silver_auto_policies
# MAGIC UNION ALL
# MAGIC SELECT 'silver_workers_comp_policies', COUNT(*),
# MAGIC   SUM(CASE WHEN _is_valid THEN 1 ELSE 0 END),
# MAGIC   ROUND(SUM(CASE WHEN _is_valid THEN 1 ELSE 0 END) * 100.0 / COUNT(*), 2)
# MAGIC FROM insurance_catalog_manu.silver.silver_workers_comp_policies
# MAGIC ORDER BY table_name;
...
# MAGIC SELECT 'dim_date' AS dimension, COUNT(*) AS row_count FROM insurance_catalog_manu.gold.dim_date
# MAGIC UNION ALL SELECT 'dim_line_of_business', COUNT(*) FROM insurance_catalog_manu.gold.dim_line_of_business
# MAGIC UNION ALL SELECT 'dim_insured', COUNT(*) FROM insurance_catalog_manu.gold.dim_insured
# MAGIC UNION ALL SELECT 'dim_location', COUNT(*) FROM insurance_catalog_manu.gold.dim_location
# MAGIC UNION ALL SELECT 'dim_agent', COUNT(*) FROM insurance_catalog_manu.gold.dim_agent
# MAGIC UNION ALL SELECT 'dim_coverage', COUNT(*) FROM insurance_catalog_manu.gold.dim_coverage
# MAGIC UNION ALL SELECT 'dim_policy', COUNT(*) FROM insurance_catalog_manu.gold.dim_policy
# MAGIC UNION ALL SELECT 'dim_claim', COUNT(*) FROM insurance_catalog_manu.gold.dim_claim
# MAGIC UNION ALL SELECT 'fact_premium', COUNT(*) FROM insurance_catalog_manu.gold.fact_premium
# MAGIC UNION ALL SELECT 'fact_claim_transaction', COUNT(*) FROM insurance_catalog_manu.gold.fact_claim_transaction
# MAGIC UNION ALL SELECT 'fact_policy_transaction', COUNT(*) FROM insurance_catalog_manu.gold.fact_policy_transaction
# MAGIC UNION ALL SELECT 'mart_policy_360', COUNT(*) FROM insurance_catalog_manu.gold.mart_policy_360
...
# MAGIC FROM insurance_catalog_manu.gold.fact_premium fp
# MAGIC JOIN insurance_catalog_manu.gold.dim_line_of_business lob ON fp.lob_key = lob.lob_key
...
# MAGIC FROM insurance_catalog_manu.gold.mart_policy_360 m
