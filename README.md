...
│   insurance_catalog_manu.bronze  │  Metadata: _ingestion_timestamp,
...
│   insurance_catalog_manu.silver  │  snake_case standardization
...
│   insurance_catalog_manu.gold    │  8 Dimensions + 3 Facts
│                             │  + mart_policy_360
└─────────────────────────────┘
```
...
### 4. Query the Mart
```sql
SELECT * FROM insurance_catalog_manu.gold.mart_policy_360
