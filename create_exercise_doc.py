...
add_code_block(
    ...
    "    Rows: 100,000\n"
    "    Table: insurance_catalog_manu.bronze.bronze_professional_liability_csv"
)
...
steps = [
    ...
    'Write to: insurance_catalog_manu.gold.dim_profession.',
]
for i, s in enumerate(steps, 1):
    doc.add_paragraph(f"{i}. {s}")
...
add_code_block(
    ...
    "spark.table('insurance_catalog_manu.silver.silver_property_policies').printSchema()\n"
    "\n"
    "# Count rows\n"
    "spark.table('insurance_catalog_manu.silver.silver_property_policies').count()\n"
    "\n"
    "# Check DQ flags\n"
